...
set CLASSPATH=%APP_HOME%\lib\lab3-1.0-SNAPSHOT.jar;%APP_HOME%\lib\log4j-core-2.14.1.jar;%APP_HOME%\lib\log4j-api-2.14.1.jar;%APP_HOME%\lib\sqlite-jdbc-3.36.0.3.jar


@rem Execute lab3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB3_OPTS%  -classpath "%CLASSPATH%" org.example.MainBD %*
